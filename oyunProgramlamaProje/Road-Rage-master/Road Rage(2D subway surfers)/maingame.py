...
pygame.display.set_caption("Slay the road!!!")
...
def start():
    ...
    while(1):
        ...
        label = font.render("Press 'Enter' or click below to start.",1,(255, 245, 224))
        screen.blit(label,(130,470))
        buttons(270,530,(194, 51, 115),"LETS GO!!",200,60)
...
def gameover():
        while(1):
            screen.blit(bgimage,(0,0))
            screen.blit(roadrage,(0,150))
            label = font3.render("GAME OVER",1,(194, 51, 115))
            screen.blit(label,(250,380))
            label2 = font4.render("PLAY AGAIN ???",1,(255, 245, 224))
